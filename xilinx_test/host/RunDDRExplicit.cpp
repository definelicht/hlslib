...
int main(int argc, char **argv) {
    ...
    auto memDevice1 = context.MakeBuffer<int, hlslib::ocl::Access::readWrite>(hlslib::ocl::StorageType::DDR, 0, DATA_SIZE);
    auto memDevice2 = context.MakeBuffer<int, hlslib::ocl::Access::readWrite>(hlslib::ocl::StorageType::DDR, 1, ddr1mem.begin(), ddr1mem.end());
