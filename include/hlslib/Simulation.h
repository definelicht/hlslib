...
//
// TODO: HLSLIB_DATAFLOW_FUNCTION does not work when calling templated
//       functions. Look into e.g. using VA args from C instead of preprocessor
//       macros, or always use variadic templates if newer Vivado HLS start
//       supporting it.
